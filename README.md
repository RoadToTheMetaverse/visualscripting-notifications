...
This README contains cross-references to Unity Standards, an initiative to help us build quality and consistency into our products from the start. For more information, see the Scholar course in Confluence [Working with Unity Standards](https://confluence.unity3d.com/x/03q5Bw).
...
2. Create a new repository for your package and clone to your desktop.
   ...
   > [US-0002](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0002/US-0002.md), 
   > [US-0003](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0003/US-0003.md), 
   > [US-0005](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0005/US-0005.md),
   > [US-0006](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0006/US-0006.md),
   > [US-0017](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0017/US-0017.md) 
...
4. **Fill in your package information.**
   ...
   > **Applicable Unity Standard:** [US-0007](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0007/US-0007.md)
...
1. **Update the *README.md* file.**
   ...
   > **Applicable Unity Standard:** [US-0023](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0023/US-0023.md)
...
1. **Rename and update your documentation file(s).**
   ...
   > **Applicable Unity Standards:** 
   [US-0013](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0013/US-0013.md), [US-0040](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0040/US-0040.md), [US-0041](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0041/US-0041.md), [US-0042](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0042/US-0042.md), [US-0043](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0043/US-0043.md), [US-0044](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0044/US-0044.md), [US-0045](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0045/US-0045.md), [US-0046](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0046/US-0046.md), [US-0053](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0053/US-0053.md), [US-0062](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0062/US-0062.md), [US-0143](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0143/US-0143.md)
...
2. **Rename and update assembly definition files.**
   ...
   > [US-0038](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0038/US-0038.md)
...
3. **Add samples to your package (code & assets).**
   ...
   * If your package contains multiple samples, make a copy of the *Samples/Example* folder for each sample, and update each *.sample.json* file accordingly.
   ...
   > **Applicable Unity Standard:** 
   > [US-0116](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0116/US-0116.md)
...
4. **Validate your package using the Validation Suite.**
   ...
   > **Applicable Unity Standard:** 
   > [US-0019](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0019/US-0019.md)

1. **Follow our design guidelines**

   Follow these design guidelines when creating your package:

	* The [UX Essentials](https://unityeditordesignsystem.unity.com/foundations/ux-checklist) in Unity's Editor Design System.
...
1. **Add tests to your package.**
      ...
      > **Applicable Unity Standard:** 
      >  [US-0018](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0018/US-0018.md)
...
3. **Update *CHANGELOG.md*.**
   ...
   > **Applicable Unity Standard:** 
   > [US-0039](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0039/US-0039.md)
...
> **Applicable Unity Standards:** 
> [US-0005](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0005/US-0005.md), [US-0006](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0006/US-0006.md), [US-0007](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0007/US-0007.md), [US-0009](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0009/US-0009.md), [US-0017](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0017/US-0017.md), [US-0074](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0074/US-0074.md), [US-0084](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0084/US-0084.md),  
...
## Ensure your package complies with Unity Standards
...
> [US-0018](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0018/US-0018.md), 
> [US-0019](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0019/US-0019.md), 
> [US-0021](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0021/US-0021.md), 
> [US-0022](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0022/US-0022.md)

## Using the Unity Standards checklist app

The Standards team provides a verification checklist app to:

-  Register your product with Release Management and determine applicable standards

-  View the mandatory and recommended standards to comply with

- Record progress towards standards compliance and provide any required evidence

The checklist is for:

- Experimental (unsupported) UPM packages. (Some standards for experimental packages are recommended and become mandatory when they move to a supported package phase.)

- Supported (pre-release, release-candidate) UPM packages 

- Entitled packages (paid-access packages limited to those with a certain license, typically [distributed via enterprise subscription SKUs](https://confluence.unity3d.com/pages/viewpage.action?pageId=106202045))

- Core packages (built-in packages bundled with the Editor)
...
For more information on how to use the checklist app, see [Validating against Unity Standards](https://docs.google.com/document/d/1Elo3F2UvTVJb4Ufm67Zzeojr-rfre5I7dhqsBl3e9X4/edit#bookmark=id.sumwrumji87z).
...
> **Applicable Unity Standards:** 
> [US-0004](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0004/US-0004.md),
> [US-0018](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0018/US-0018.md),
> [US-0021](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0021/US-0021.md),
> [US-0022](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0022/US-0022.md),
> [US-0029](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0029/US-0029.md),
> [US-0054](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0054/US-0054.md)
...
See [Validating against Unity Standards](https://docs.google.com/document/d/1Elo3F2UvTVJb4Ufm67Zzeojr-rfre5I7dhqsBl3e9X4/edit#bookmark=id.sumwrumji87z)
...
**How do I add a help icon button in my package's window?**

   > **Applicable Unity Standard:** [US-0132](https://github.cds.internal.unity3d.com/unity/standards/blob/master/definitions/US-0132/US-0132.md)

[https://confluence.unity3d.com/pages/viewpage.action?spaceKey=PAK&title=FAQ+-+Authoring+Packages#FAQAuthoringPackages-HowdoIaddahelpiconbuttoninmypackage'swindow?](https://confluence.unity3d.com/pages/viewpage.action?spaceKey=PAK&title=FAQ+-+Authoring+Packages#FAQAuthoringPackages-HowdoIaddahelpiconbuttoninmypackage'swindow?)

**Where can I find out more about Unity Standards?**

https://docs.google.com/document/d/1Elo3F2UvTVJb4Ufm67Zzeojr-rfre5I7dhqsBl3e9X4/edit?usp=sharing
